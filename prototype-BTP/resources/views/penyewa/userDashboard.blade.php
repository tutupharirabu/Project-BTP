        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col mb-0">
                <div class="container ml-4">
                    <h4>Dashboard Peminjaman/Penyewaan Ruangan</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-4 mb-2">
                <div class="container my-2">
                    <a class="" href="/dashboardPenyewa"
                        style="color: #028391;font-size:12px;font-weight: bold;">Dashboard</a>
                </div>
            </div>
        </div>
        <div class="p-3 border mb-5"
            ...
            <div id="ruanganCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <button class="carousel-control-prev" type="button" data-bs-target="#ruanganCarousel" data-bs-slide="prev"
                    style="color:#028391; left: -6%">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#ruanganCarousel" data-bs-slide="next"
                    style="color:#028391; right: -6%;">
            ...
            <div class="row mt-4">
                <div class="d-md-flex justify-content-center w-100">
                    <a type="button" class="btn btn-sm text-white text-capitalize"
                        style="background-color: #2CA700; font-size: 16px; border-radius: 7px;"
                        href="/daftarRuanganPenyewa">Lihat Ruangan Lainnya</a>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn text-white text-capitalize" data-bs-dismiss="modal"
