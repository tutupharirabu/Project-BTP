    ...
    <div class="row">
        <div class="col-sm-12 col-md-6 col-lg-4 mb-2">
            <div class="container my-2 mx-2">
                <a class="" href="/dashboardPenyewa" style="color: #028391;font-size:12px;font-weight: bold;">Dashboard</a>
            </div>
        </div>
    </div>
    <div class="p-3 border mb-5" style="border: 6px solid #61677A; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-4 mt-3">
                                    <div class="position-relative">
                                        <img src="{{ asset('assets/' . $ruangan->gambar->first()->url) }}"
                                            class="card-img-top custom-img" alt="Gambar Ruangan" style="width:320px; height: 215px;">
