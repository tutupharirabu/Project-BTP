        ...
        <div class="row justify-content-center mt-2">
            <div class="col-11">
                <div class="card border shadow shadow-md p-2">
                    <div class="card-body">
                        <form id="rentalForm" action="/meminjamRuangan/posts" method="POST" class="form-valid" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md mt-4">
                                <div class="d-grid gap-2 d-flex justify-content-end">
                                    <button type="button" class="btn text-white button-style capitalize-first-letter" style="" onclick="showConfirmationModal(event)">Ajukan</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn button-style text-white capitalize-first-letter" form="rentalForm">Konfirmasi</button>
                </div>
            </div>
        </div>
    </div>
