    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="background-color: white;">
            <div class="navbar-nav" style="margin-left:20px;">
                ...
                <a class="nav-link" href="/statusPengajuanAdmin" style="font-weight: 900;">Status Pengajuan
                    Peminjaman/Penyewaan Ruangan</a>
                <a class="nav-link" href="/okupansiRuanganAdmin" style="font-weight: 900;">Okupansi Ruangan</a>
                <a class="nav-link" href="/riwayatPeminjamanRuanganAdmin" style="font-weight: 900;">Riwayat Ruangan</a>
