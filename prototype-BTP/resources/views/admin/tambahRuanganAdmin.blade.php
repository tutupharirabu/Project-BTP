                    ...
                    <form action="{{route('dropzone.store')}}" method="POST" enctype="multipart/form-data" id="my-form">
                        ...
                        <div class="row">
                            <div class="col-7">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-md-3 col-form-label text-md-right">Nama Ruangan</label>
                                    <div class="col-md-7">
                                        <input type="text" id="name" class="form-control" name="name" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="capacity" class="col-md-3 col-form-label text-md-right">Kapasitas</label>
                                    <div class="col-md-7">
                                        <input type="number" id="capacity" class="form-control" name="capacity" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="col-5">
                                <div class="form-group row">
                                    <label for="room_image" class="col-md-4 col-form-label text-md-right">Gambar Ruangan</label>
                                </div>
                                ...
                                <div class="form-group row mb-0 justify-content-end">
                                    <div class="col-auto"> <!-- Menggunakan class col-auto agar kolom menyesuaikan dengan ukuran kontennya -->
