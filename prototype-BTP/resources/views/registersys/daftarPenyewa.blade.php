        ...
        <div class="container-sm">
            ...
            <form class="row g-3 needs-validation" action="{{ route('posts.daftarPenyewa') }}" method="POST" class="form-valid" enctype="multipart/form-data" novalidate>
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="instansi" name="instansi" placeholder="Masukkan nama instansi anda" required>
                  <div class="invalid-feedback">
                ...
                <div class="col-md-12">
                  ...
                  <textarea name="alamat" id="alamat" cols="30" rows="10" class="form-control" style="height: 100px" placeholder="Masukkan alamat anda" required></textarea>
                  <div class="invalid-feedback">
