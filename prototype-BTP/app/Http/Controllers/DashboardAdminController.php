    ...
    public function index()
{
    ...
    foreach ($peminjamans as $peminjaman) {
        $startMonth = Carbon::parse($peminjaman->tanggal_mulai)->month;
        $endMonth = Carbon::parse($peminjaman->tanggal_selesai)->month;

        // Calculate the number of days between the start and end of the booking
